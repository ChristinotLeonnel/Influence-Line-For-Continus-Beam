...
class Output:
    ...
    def compute(self, force: bool = ...) -> None: ...
    @property
    def compute_load_envelopes(self, force: bool = ...) -> None: ...
    ...
    def set_loads(
        self,
        point_loads: Sequence[Load] = ...,
        distrib_loads: Sequence[Load] = ...,
    ) -> None: ...
    @property
    def structural_model(self) -> Dict[str, Any]: ...
    ...
    def generate_calculation_note(
        ...
        *,
        ...
        curve_plotter: Optional[Callable[..., str]] = ...,
    ) -> str: ...
